    ...
    >
      <div className="absolute top-3 right-3 flex gap-1 z-30">
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8 hover:bg-primary/10 hover:text-primary transition-colors bg-card/80 backdrop-blur-sm shadow-sm opacity-100 dark:bg-gray-800/80 dark:text-gray-300 dark:hover:text-white"
        ...
        <Button
          variant="ghost"
          size="icon"
          className="h-8 w-8 hover:bg-destructive/10 hover:text-destructive transition-colors bg-card/80 backdrop-blur-sm shadow-sm opacity-100 dark:bg-gray-800/80 dark:text-gray-300 dark:hover:text-destructive"
      ...
      <div className="flex items-start gap-4">
        <button 
          ...
          className={cn(
            "mt-1 flex-shrink-0 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 rounded-full",
